...
export default function BodyInside() {
  return (
    <Box sx={{ width: '100%',height:"96vh" }} style={{'backgroundColor':"#EEF5F9","overflow":"hidden"}}>
        <Typography>
      ...
      <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
        <Grid xs={2} style={{"margin-left": "80px",width:200,height:150}} spacing={10} >
            <Item>
        ...
        <Grid xs={2} style={{width:200,height:150}} spacing={10}>
          <Item><Box sx={{width:100,height:100}}>
            <img src={refresh} style={{height:80}}/>
            <p>Agriculture</p>
            <p>3</p>
          </Box></Item>
        </Grid>
        <Grid xs={2} spacing={10} style={{width:200,height:150}}>
          <Item><Box sx={{width:100,height:100}}>
            <img src={refresh} style={{height:80}}/>
            <p>Agriculture</p>
            <p>3</p>
      ...
      <Button variant="outlined" style={{"margin-left": "600px","color": "#14213D","border":"1px solid  #14213D","width":"200px",
